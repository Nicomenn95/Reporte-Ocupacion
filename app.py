    ...
    with st.spinner("Procesando el archivo de forma automática..."):
        try:
            ...
            if 'Estado' not in df.columns:
                ...
                # --- CAMBIO IMPORTANTE: AHORA USAMOS 'Fecha de viaje' ---
                # Seguimos usando 'Hora salida' y 'Hora llegada' para el orden cronológico real, 
                # pero guardamos la fecha de viaje oficial para la columna final.
                ...
                for _, row in df_pagados.iterrows():
                    ...
                    # Limpiamos la Fecha de viaje por si viene con horas pegadas
                    ...
                    paradas_list.append({
                        ...
                        'DateTime': row['DateTime_Origen'], # Se usa solo para ordenar
                        'Fecha_Oficial': fecha_viaje_limpia # Esta es la que se mostrará
                    })
                    paradas_list.append({
                        'Folio': folio, 'Ruta': ruta,
                ...
                if not res_dfs:
                    ...
                    # Calculamos el día en base a la Fecha de Viaje Oficial
                    ...
                    # --- DISEÑO DEL EXCEL (COLORES POR FOLIO) ---
                    output = io.BytesIO()
                    with pd.ExcelWriter(output, engine='openpyxl') as writer:
                        ...
                        color_celeste = PatternFill(start_color="E6F2FF", end_color="E6F2FF", fill_type="solid") # Azul claro muy legible
                        
                        # Encabezados en negrita
                        for cell in worksheet[1]:
                            cell.font = Font(bold=True)
                        
                        # Lógica para alternar colores cada vez que cambia el Folio
                        ...
                        for row in range(2, worksheet.max_row + 1):
                            ...
                            # Si el folio cambió respecto a la fila anterior, cambiamos de color
                        ...
                        # Ajustar anchos
                        worksheet.column_dimensions['D'].width = 15 # Ciudad
                        worksheet.column_dimensions['F'].width = 30 # Paradero
